...
class CIFAR10:
    ...
    def __init__(self):
       ...
       # data_root = '/public/MountData/dataset/cifar10' # ****
        data_root = '/public/ly/CVPR2022/dataset/'
...
class CIFAR100:
    def __init__(self, args):
        ...
        data_root = '/public/ly/CVPR2022/dataset/cifar100/'
        use_cuda = torch.cuda.is_available()
        ...
        self.val_loader = torch.utils.data.DataLoader(
            test_dataset, batch_size=args.batch_size, num_workers=0, pin_memory=True
        )
